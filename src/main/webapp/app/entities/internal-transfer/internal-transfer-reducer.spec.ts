...
import reducer, {
  ...
  reset,
  updateEntity,
} from './internal-transfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNALTRANSFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTERNALTRANSFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTERNALTRANSFER actions', async () => {
      const arg = { id: 6547 };
    ...
    it('dispatches UPDATE_INTERNALTRANSFER actions', async () => {
      const arg = { id: 6547 };
    ...
    it('dispatches PARTIAL_UPDATE_INTERNALTRANSFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTERNALTRANSFER actions', async () => {
      const arg = 42666;
