...
import reducer, {
  ...
  reset,
  updateEntity,
} from './financial-account.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIALACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINANCIALACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINANCIALACCOUNT actions', async () => {
      const arg = { id: 21556 };
    ...
    it('dispatches UPDATE_FINANCIALACCOUNT actions', async () => {
      const arg = { id: 21556 };
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINANCIALACCOUNT actions', async () => {
      const arg = 42666;
