...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONINGESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSACTIONINGESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSACTIONINGESTION actions', async () => {
      const arg = { id: 13542 };
    ...
    it('dispatches UPDATE_TRANSACTIONINGESTION actions', async () => {
      const arg = { id: 13542 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONINGESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSACTIONINGESTION actions', async () => {
      const arg = 42666;
