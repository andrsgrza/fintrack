...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGESTIONRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INGESTIONRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INGESTIONRECORD actions', async () => {
      const arg = { id: 2817 };
    ...
    it('dispatches UPDATE_INGESTIONRECORD actions', async () => {
      const arg = { id: 2817 };
    ...
    it('dispatches PARTIAL_UPDATE_INGESTIONRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INGESTIONRECORD actions', async () => {
      const arg = 42666;
