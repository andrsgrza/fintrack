...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONRULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSACTIONRULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSACTIONRULE actions', async () => {
      const arg = { id: 14783 };
    ...
    it('dispatches UPDATE_TRANSACTIONRULE actions', async () => {
      const arg = { id: 14783 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONRULE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSACTIONRULE actions', async () => {
      const arg = 42666;
