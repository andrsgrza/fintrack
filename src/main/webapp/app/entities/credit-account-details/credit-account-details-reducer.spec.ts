...
import reducer, {
  ...
  reset,
  updateEntity,
} from './credit-account-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITACCOUNTDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CREDITACCOUNTDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CREDITACCOUNTDETAILS actions', async () => {
      const arg = { id: 29673 };
    ...
    it('dispatches UPDATE_CREDITACCOUNTDETAILS actions', async () => {
      const arg = { id: 29673 };
    ...
    it('dispatches PARTIAL_UPDATE_CREDITACCOUNTDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CREDITACCOUNTDETAILS actions', async () => {
      const arg = 42666;
