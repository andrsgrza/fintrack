...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEINGESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FILEINGESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FILEINGESTION actions', async () => {
      const arg = { id: 8574 };
    ...
    it('dispatches UPDATE_FILEINGESTION actions', async () => {
      const arg = { id: 8574 };
    ...
    it('dispatches PARTIAL_UPDATE_FILEINGESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FILEINGESTION actions', async () => {
      const arg = 42666;
