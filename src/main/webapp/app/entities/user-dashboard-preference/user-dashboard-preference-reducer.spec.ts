...
import reducer, {
  ...
  reset,
  updateEntity,
} from './user-dashboard-preference.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDASHBOARDPREFERENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERDASHBOARDPREFERENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERDASHBOARDPREFERENCE actions', async () => {
      const arg = { id: 8066 };
    ...
    it('dispatches UPDATE_USERDASHBOARDPREFERENCE actions', async () => {
      const arg = { id: 8066 };
    ...
    it('dispatches PARTIAL_UPDATE_USERDASHBOARDPREFERENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERDASHBOARDPREFERENCE actions', async () => {
      const arg = 42666;
