...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIACCESSTOKEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIACCESSTOKEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIACCESSTOKEN actions', async () => {
      const arg = { id: 14142 };
    ...
    it('dispatches UPDATE_APIACCESSTOKEN actions', async () => {
      const arg = { id: 14142 };
    ...
    it('dispatches PARTIAL_UPDATE_APIACCESSTOKEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIACCESSTOKEN actions', async () => {
      const arg = 42666;
