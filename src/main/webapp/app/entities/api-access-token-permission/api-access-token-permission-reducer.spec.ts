...
import reducer, {
  ...
  reset,
  updateEntity,
} from './api-access-token-permission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIACCESSTOKENPERMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIACCESSTOKENPERMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIACCESSTOKENPERMISSION actions', async () => {
      const arg = { id: 27054 };
    ...
    it('dispatches UPDATE_APIACCESSTOKENPERMISSION actions', async () => {
      const arg = { id: 27054 };
    ...
    it('dispatches PARTIAL_UPDATE_APIACCESSTOKENPERMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIACCESSTOKENPERMISSION actions', async () => {
      const arg = 42666;
