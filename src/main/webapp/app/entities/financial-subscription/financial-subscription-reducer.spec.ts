...
import reducer, {
  ...
  reset,
  updateEntity,
} from './financial-subscription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIALSUBSCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINANCIALSUBSCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINANCIALSUBSCRIPTION actions', async () => {
      const arg = { id: 26145 };
    ...
    it('dispatches UPDATE_FINANCIALSUBSCRIPTION actions', async () => {
      const arg = { id: 26145 };
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALSUBSCRIPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINANCIALSUBSCRIPTION actions', async () => {
      const arg = 42666;
