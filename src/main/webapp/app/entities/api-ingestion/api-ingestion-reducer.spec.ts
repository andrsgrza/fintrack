...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIINGESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIINGESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIINGESTION actions', async () => {
      const arg = { id: 21915 };
    ...
    it('dispatches UPDATE_APIINGESTION actions', async () => {
      const arg = { id: 21915 };
    ...
    it('dispatches PARTIAL_UPDATE_APIINGESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIINGESTION actions', async () => {
      const arg = 42666;
