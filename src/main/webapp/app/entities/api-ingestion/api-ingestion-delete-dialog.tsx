...
import { deleteEntity, getEntity } from './api-ingestion.reducer';

export const ApiIngestionDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(apiIngestionEntity.id));
  };

  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="apiIngestionDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-apiIngestion" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
...
export default ApiIngestionDeleteDialog;
