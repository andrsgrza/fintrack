...
import reducer, {
  ...
  reset,
  updateEntity,
} from './transaction-rule-condition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONRULECONDITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSACTIONRULECONDITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSACTIONRULECONDITION actions', async () => {
      const arg = { id: 31345 };
    ...
    it('dispatches UPDATE_TRANSACTIONRULECONDITION actions', async () => {
      const arg = { id: 31345 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONRULECONDITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSACTIONRULECONDITION actions', async () => {
      const arg = 42666;
