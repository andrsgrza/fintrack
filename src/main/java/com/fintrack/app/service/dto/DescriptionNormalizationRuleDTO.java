...
/**
 * A DTO for the {@link com.fintrack.app.domain.DescriptionNormalizationRule} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DescriptionNormalizationRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DescriptionNormalizationRuleDTO)) {
            return false;
        }
        DescriptionNormalizationRuleDTO that = (DescriptionNormalizationRuleDTO) o;
