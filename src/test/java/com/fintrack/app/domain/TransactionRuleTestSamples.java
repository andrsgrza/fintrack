...
public class TransactionRuleTestSamples {
    ...
    public static TransactionRule getTransactionRuleSample1() {
        return new TransactionRule().id(1L).name("name1").description("description1").priority(1);
    }

    public static TransactionRule getTransactionRuleSample2() {
        return new TransactionRule().id(2L).name("name2").description("description2").priority(2);
    }
