...
public class CategoryTestSamples {
    ...
    public static Category getCategorySample1() {
        return new Category().id(1L).name("name1").description("description1").color("color1").icon("icon1");
    }

    public static Category getCategorySample2() {
        return new Category().id(2L).name("name2").description("description2").color("color2").icon("icon2");
    }
