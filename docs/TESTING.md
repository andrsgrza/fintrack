...
| ----------------------- | ------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Integration IT          | `FinancialAccountResourceIT`                            | **149** | Custom ownership + immutability + timestamp hardening + initialBalance monetary scale + delete orchestration + candidate account-reference guards + date-floor + balance/overview endpoint tests, plus JHipster CRUD/filters |
