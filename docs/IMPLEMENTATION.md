...
3. ✅ Backend-only draft preview endpoint: `POST /api/financial-transactions/rule-preview`; no save/mutation/application; no UI.
4. Planned manual create two-step preview UI: Step 1 transaction details → preview endpoint → Step 2 category/tags prepopulated from suggestions and editable before save.
