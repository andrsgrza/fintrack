...
| Item               | Plan                                                                                                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Endpoint           | `POST /api/transaction-ingestions/file` multipart with `accountId` + `file` for canonical product creation; `POST /api/transaction-ingestions/file-preview` remains as compatibility/delegated preview. |
...
| Item     | Status                                                                                                                                                                                                                                                                           |
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Entry    | ✅ Canonical TransactionIngestion FILE creation workflow at `/transaction-ingestion/new`, linked from the TransactionIngestion list; `/transaction-ingestion/file-preview/new` remains compatibility/delegated; FileIngestion create is parent-scoped upload, not metadata CRUD. |
...
| 2026-07-17 | CSV Ingestion I1A/I1B backend ✅: canonical CSV parser/validator + `POST /api/transaction-ingestions/file-preview`; persists `TransactionIngestion`, `FileIngestion`, and preview `IngestionRecord`s only; no DB/JDL/Liquibase, no `FinancialTransaction` creation, no Rule Engine. Superseded for product creation by the 2026-07-18 `/api/transaction-ingestions/file` workflow; retained as compatibility/delegated preview. |
| 2026-07-17 | CSV Ingestion I1C frontend ✅: initial TransactionIngestion “New File Import” workflow at `/transaction-ingestion/file-preview/new`; superseded for product creation by the 2026-07-18 `/transaction-ingestion/new` parent-centered workflow.                                                                                                                                                                                   |
