...
## TransactionCandidate — TC-1/TC-2C.1a manual draft foundation + backend rule commands
...
| Candidate-specific rule-preview/apply UI        | ⏳     | TC-2C.1b deferred; TC-2B.1 candidate create/post does not call `rule-preview` or apply TransactionRules                                                                                                    |
